...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    var index_header_link_call = document.getElementById("cargo_consalidation_header_link_call");
    var index_banner_union_right = document.getElementById("cargo_consalidation_banner_link_call");
    var index_content_link_call = document.getElementById("cargo_consalidation_content_link_call");
...
// Для хедера
document.getElementById('cargo_consalidation_header_button').addEventListener('click', function() {
    ...
    fetch('/send', {
        ...
        body: JSON.stringify({ name, phone, email, source: 'Страница: Консолидация посылок' }),  // Добавляем источник
    })
    .then(response => {
        if (!response.ok) {
...
// Для банера
document.getElementById('cargo_consalidation_banner_button').addEventListener('click', function() {
...
// Для контента
document.getElementById('cargo_consalidation_content_button').addEventListener('click', function() {
