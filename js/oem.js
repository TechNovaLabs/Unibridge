...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    var index_header_link_call = document.getElementById("oem_header_link_call");
    var index_banner_union_right = document.getElementById("oem_banner_link_call");
    var index_content_link_call = document.getElementById("oem_content_link_call");
...
// Для хедера
document.getElementById('oem_header_button').addEventListener('click', function() {
    ...
    fetch('/send', {
        ...
        body: JSON.stringify({ name, phone, email, source: 'Страница: Свой бренд (OEM)' }),  // Добавляем источник
    })
    .then(response => {
        if (!response.ok) {
...
// Для банера
document.getElementById('oem_banner_button').addEventListener('click', function() {
...
// Для контента
document.getElementById('oem_content_button').addEventListener('click', function() {
