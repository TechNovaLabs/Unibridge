...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    var auto_delivery_header_link_call = document.getElementById("auto_delivery_header_link_call");
    var auto_delivery_banner_link_call = document.getElementById("auto_delivery_banner_link_call");
    

    auto_delivery_header_link_call.onclick = function(event) {
        event.preventDefault();
        modal.style.display = "block";
    }

    auto_delivery_banner_link_call.onclick = function(event) {
        event.preventDefault();
        modal.style.display = "block";
    }
