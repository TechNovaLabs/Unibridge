...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    var index_banner_union_right = document.getElementById("button_contact_us_payment");
...
document.getElementById('all_service_header_button').addEventListener('click', function() {
    ...
    fetch('/send', {
        ...
        body: JSON.stringify({ name, phone, email, source: 'Страница: оплата в Китай' }),  // Добавляем источник
    })
    .then(response => {
        if (!response.ok) {
...
// Для контента
document.getElementById('payment_banner_button').addEventListener('click', function() {
