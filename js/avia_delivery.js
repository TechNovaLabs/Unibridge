...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    var avia_delivery_header_link_call = document.getElementById("avia_delivery_header_link_call");
    var avia_delivery_banner_link_call = document.getElementById("avia_delivery_banner_link_call");
    

    avia_delivery_header_link_call.onclick = function(event) {
        event.preventDefault();
        modal.style.display = "block";
    }

    avia_delivery_banner_link_call.onclick = function(event) {
        event.preventDefault();
        modal.style.display = "block";
    }
