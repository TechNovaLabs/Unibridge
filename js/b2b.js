...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    var index_banner_union_right = document.getElementById("button_contact_us_b2b");
...
document.getElementById('all_service_header_button').addEventListener('click', function() {
    ...
    fetch('/send', {
        ...
        body: JSON.stringify({ name, phone, email, source: 'Страница: B2B' }),  // Добавляем источник
    })
    .then(response => {
        if (!response.ok) {
...
// Для контента
document.getElementById('b2b_banner_button').addEventListener('click', function() {
