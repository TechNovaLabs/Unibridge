...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    var purchase_lots_header_link_call = document.getElementById("purchase_lots_header_link_call");
    var purchase_lots_banner_link_call = document.getElementById("purchase_lots_banner_link_call");
    

    purchase_lots_header_link_call.onclick = function(event) {
        event.preventDefault();
        modal.style.display = "block";
    }

    purchase_lots_banner_link_call.onclick = function(event) {
        event.preventDefault();
        modal.style.display = "block";
    }
