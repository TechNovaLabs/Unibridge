...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    var index_header_link_call = document.getElementById("purchase_lots_header_link_call");
    var index_banner_union_right = document.getElementById("purchase_lots_banner_link_call");
...
// Для хедера
document.getElementById('purchase_lots_header_button').addEventListener('click', function() {
    ...
    fetch('/send', {
        ...
        body: JSON.stringify({ name, phone, email, source: 'Страница: Выкуп малых и крупных партий' }),  // Добавляем источник
    })
    .then(response => {
        if (!response.ok) {
...
// Для контента
document.getElementById('purchase_lots_banner_button').addEventListener('click', function() {
