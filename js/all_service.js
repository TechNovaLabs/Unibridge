...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    var index_header_link_call = document.getElementById("all_service_header_link_call");
    var index_banner_union_right = document.getElementById("button_contact_us_all_service");
...
// Для хедера
document.getElementById('all_service_header_button').addEventListener('click', function() {
    ...
    fetch('/send', {
        ...
        body: JSON.stringify({ name, phone, email, source: 'Страница: Выкуп товара' }),  // Добавляем источник
    })
    .then(response => {
        if (!response.ok) {
...
// Для контента
document.getElementById('all_service_banner_button').addEventListener('click', function() {
